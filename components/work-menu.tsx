  ...
  return (
    ...
    >
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className="flex items-center gap-1 px-2 py-2 transition-colors hover:text-fg data-[open=true]:text-fg"
        data-open={open}
      >
        Work
        ...
        {open && (
          <div className="absolute right-0 top-full pt-2">
            <motion.div
              ...
              className="w-[360px] overflow-hidden rounded-card border border-border bg-surface p-2 font-sans shadow-card"
            >
              {ALL_CASES.map((c) => {
