...
const data: CaseData = {
  ...
  subhead:
    "AI can produce design work 10× faster, and produce design slop 10× faster. So I encoded my judgment into a system: a pipeline that takes a project brief to a working prototype, and blocks anything that doesn't pass a 10-gate audit. It's open source, so don't take my word for it. Clone it and run it.",
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { t: "metric", items: [
          { value: "176/176", label: "Self-tests passing, CI green on every PR" },
          { value: "10", label: "Audit gates, each a script with the power to block handoff" },
          { value: "28", label: "Scripts across the pipeline" },
        ] },
