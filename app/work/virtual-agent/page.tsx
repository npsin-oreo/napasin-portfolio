...
const data: CaseData = {
  ...
  snapshot: [
    ["Role", "UX/UI Designer (brand and product)"],
    ["Timeline", "March 2026 onward · MVP in pilot"],
  ...
  sections: [
    {
      ...
      blocks: [
        { t: "p", text: "Large financial businesses, insurers, banks, and lenders, live on the phone. Payment reminders, promotion offers, follow-ups, questions: millions of routine calls that must happen, every month." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "list", items: [
          "The one-to-one ceiling is gone. Routine calls, the reminders, notifications, and prescreening, run at whatever scale the campaign needs, with escalation to humans built into the flow.",
        ...
        { t: "p", text: "Delivered end to end: brand identity, bilingual TH/EN guidelines, agent-configuration platform, and campaign ops dashboard. Client metrics are confidential; I'm happy to walk through the design process in detail in conversation." },
      ],
    },
  ],
  learnings: [
