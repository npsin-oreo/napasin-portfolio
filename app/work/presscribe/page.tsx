...
export const metadata: Metadata = {
  ...
  description:
    "An AI medical scribe that turns doctor and patient conversations into clinical notes. A case study in AI trust design: invisible during the consultation, accountable after it.",
};
...
const data: CaseData = {
  ...
  snapshot: [
    ["Role", "UX/UI Designer"],
    ["Timeline", "Mid 2024 to early 2025 release, ongoing"],
    ["Team", "Project manager, medical consultant, ML engineers"],
    ["Scope", "Product design, AI UX (trust, review, failure states), design system and tokens, EMR/HIS integration UX"],
  ],
  impact: [
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { t: "p", text: "The systemic insight surfaced quickly. Most large Thai hospitals run on HIS platforms that are 10 to 20 years old. Features have been bolted on for decades, but the UX has never been redesigned, so every new capability adds another screen, another click, another workaround. The burden lands on the people at the front line, every shift, every day." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "list", items: [
          ...
          "Automation against accountability. AI drafts; the doctor signs.",
          "Clinical standards against personal style: standard enough to be safe, flexible enough to sound like the doctor who owns them.",
        ] },
      ],
    },
    {
      ...
      blocks: [
        ...
        { t: "list", items: [
          ...
          "Privacy and consent, designed at the root: no audio is stored. PresScribe listens and summarizes; there is no recording to leak, archive, or subpoena. In the hospitals running it, that architecture shows: patients aren't anxious about the AI in the room.",
        ] },
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "p", text: "The flow is a checkpoint, not an auto-save. The moment the doctor ends the session and asks for the note, the AI's summary appears for review, to read, recheck, and correct, and only a deliberate action commits it to the record. Nothing reaches the system unseen; nothing is kept but the note (the audio is never stored, only listened to)." },
        ...
        { t: "sub", text: "Style against standard" },
        ...
        { t: "p", text: "From the diagnosis, PresScribe suggests the matching ICD-10 codes on the same contract as the note: the AI proposes, the doctor confirms. Coding, usually a separate after-hours chore, folds into the moment the note is signed." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "list", items: [
          "Level 1, copy and paste. Works today, in any hospital, zero IT. The note is formatted to paste cleanly into any HIS field.",
    ...
    },
    {
      ...
      blocks: [
        { t: "metric", items: [
          ...
          { value: "45", label: "Hospitals nationwide" },
        ...
        { t: "p", text: "Per case, documentation time drops by roughly 30 to 40%, enough that a doctor can see more patients in the same clinic, and the after-hours retyping simply stops." },
        ...
        { t: "p", text: "And it runs every day inside KindMore Clinic, where consultations average 7:56 of undivided attention, and patients rate the experience 5.0★ across 170+ reviews." },
      ],
    },
  ],
  learnings: [
