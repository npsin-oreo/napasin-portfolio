...
export const metadata: Metadata = {
  ...
  description:
    "A real clinic designed end to end as a living sandbox. Service design plus AI turned a whole-day doctor visit into about 20 minutes, with a 5.0★ rating from 170+ reviews.",
};
...
const data: CaseData = {
  ...
  snapshot: [
    ["Role", "UX/UI Designer"],
    ["Timeline", "Sep 2025 to Mar 2026 opening. Operating and expanding."],
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        { t: "p", text: "So we built one. KindMore Clinic (ใกล้หมอ) is a real, operating medical clinic, with real patients, real staff, and real doctors, that doubles as a living sandbox where service-design decisions get tested against reality and measured every day." },
      ],
    },
    {
      n: "02",
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "p", text: "By the time a patient enters, the doctor has already seen the chief complaint, history, and vitals, all surfaced by our HIS. The consultation starts at the problem, not at “so, what brings you here?”" },
    ...
    },
    {
      ...
      title: "Outcome",
      blocks: [
        { t: "compare", before: { label: "A traditional visit", value: "A whole day" }, after: { label: "KindMore, door to door", value: "20:49" } },
        { t: "metric", items: [
        ...
        { t: "p", text: "800+ visits a month, 500+ new patients, about 28 visits a day. And 5.0★ across 170+ Google reviews, four consecutive months at 100% five-star. Unprompted, nearly a quarter of reviewers mention speed: “Fast service.” “Very welcoming.” “Friendly and kind throughout.”" },
