...
const data: CaseData = {
  ...
  coverFit: "cover",
  kicker: "Short case · Data platform",
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "art", src: "/images/scam-network.jpg", label: "Fragmented data across many organizations becomes one readable picture (illustrative)" },
      ],
    },
    {
      n: "03",
